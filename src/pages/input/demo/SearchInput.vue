<template lang="html">
  <div>
    <code-box id="components-input-demo-search-input" title="输入框组合" :code="code" :description="description">
      <div slot="instance">
        <search-input placeholder="input search text"
          :on-search="handleSearch" style="width: 200px;"
        ></search-input>
      </div>
    </code-box>
  </div>
...
import { template as description } from './search-input.md'
